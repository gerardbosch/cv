...
\tlcventry{2022}{0}{(Break) / Software Engineer}{Self employed}{Barcelona}{}{
  \begin{itemize}\setlength\itemsep{-0.5pt}
    ...
    \item Took a break from industry. Learning about finances, markets and investments.
  \end{itemize}
  \vspace{-3pt}
...
\cvdoubleitemMy[cvdiAddToLen=37pt]
  ...
  {Interest\\ Areas}{
    ...
    Big\slash Fast Data \& Streaming, DLTs\slash Blockchain \& Web3, Artificial Intelligence.
  }
...
\cvdoubleitemMy[cvdiAddToLen=37pt]
  ...
  {Others}{
    Git, Maven\slash Gradle\slash sbt, JGitVer, Docker, OpenShift, Devcontainers, Testcontainers, DevOps, GitHub, GitLab, Cloudflare, \LaTeX, Linux, Nix, Microservices, Cloud Native, OpenAPI, AsyncAPI, API first, oAuth.
  }
