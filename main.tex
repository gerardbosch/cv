...
\tlcventry{2022}{0}{(Break) / Software Engineer}{Self employed}{Barcelona}{}{
  ...
  \begin{itemize}\setlength\itemsep{-0.5pt}
    \item Algorithmic trading, research, design \& implementation of safety mechanisms for loss control, as well
          as key metrics collection/reporting using DDD \& Hexagonal arch.
