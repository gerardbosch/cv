...
%\cvdoubleitem{Operating Systems}{MS Windows, GNU/Linux (installation, administration, configuration and server administration.)}
...
\cvdoubleitem{Programming languages}{Kotlin, Scala, Java, Bash, Haskell, Python, Perl, SQL.}
...
\cvdoubleitem{Development methodologies}{FP patterns, GoF design patterns, SOLID, Clean Code, Hexagonal/Clean Architecture, 12-Factor, Railway oriented programming, Agile development, SCRUM, Domain Driven Design, TDD.}
