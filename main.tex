...
\vspace{-2ex}\centerline{
  \href{https://gerardbosch.github.io/cv/}{\emoji{person-gesturing-ok} \textcolor{black}{This CV is \textcolor{magenta}{live!} Click here to ensure you access the most \textbf{up-to-date} version \emoji{person-gesturing-ok}}}
}\vspace{4ex}
