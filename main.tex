...
\firstname{Gerard}
\familyname{Bosch}
\title{Freelancer/Indep. Contractor}               % optional, remove the line if not wanted
...
\cvdoubleitemMy[cvdiAddToLen=7ex]
...
\cvdoubleitemMy[cvdiAddToLen=7ex]
  {Development Methodologies}{FP patterns, GoF design patterns, SOLID, Clean Code, Hexagonal/Clean Architecture, 12-Factor, Railway oriented programming, Agile development, SCRUM, Domain Driven Design, TDD.}
  {Others}{Git, Maven/Gradle/sbt, JGitVer, Docker, OpenShift, Devcontainers, Testcontainers, DevOps, GitHub, GitLab, Cloudflare, \LaTeX, Linux, Nix, Cloud Computing.}
