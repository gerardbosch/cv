...
\cvcomputer{Programming languages}{Kotlin, Scala, Java, Bash, Haskell, Python, Perl, SQL.}
...
\cvcomputer{Development methodologies}{FP patterns, GoF design patterns, SOLID, Clean Code, Hexagonal/Clean Architecture, 12-Factor, Railway oriented programming, Agile development, SCRUM, Domain Driven Design, TDD.}
