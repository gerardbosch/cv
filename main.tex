...
\usepackage[firstyear=2010, lastyear=2024]{moderntimeline}
...
\firstname{Gerard}
\familyname{Bosch}
\title{Software Engineer,\\ \large{Freelancer/Indep. Contractor}} % optional, remove the line if not wanted
...
\tlcventry{2022}{0}{(Break) / Software Engineer}{Self employed}{Barcelona}{}{
